...
class PageThree(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="3ª CONFERÊNCIA - LIVRO 02 - REGISTRO GERAL", font=("Helvetica", 15))
        label.pack(pady=10)
        ...
        button1 = tk.Button(center_frame, text="Criar meta", font=("Helvetica", 16),
                            command=lambda: controller.show_frame("CadastroDeMetasRegistroGeral"))
        button1.pack(pady=10)

        button2 = tk.Button(center_frame, text="Cadastrar relatorio", font=("Helvetica", 16),
                            command=lambda: controller.show_frame("PageConferenciaLivro02"))
        button2.pack(pady=10)

        button2 = tk.Button(center_frame, text="Historico de Cadastro", font=("Helvetica", 16),
                            command=lambda: controller.show_frame("PageHistoricoRG"))
        button2.pack(pady=10)
