...
class PageConferenciaLivro02(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="Detalhes 3ª CONFERÊNCIA - LIVRO 02 - REGISTRO GERAL", font=("Helvetica", 24))
    ...
    def gerar_relatorio(self, meta_id, data_atual):
        ...
        caminho_pasta = "C:/Users/Rhenn/OneDrive/Área de trabalho/Projetos"
        nome_arquivo = f"relatorio_conferencia_REGISTRO_GERAL_{data_atual}.pdf"
    ...
    def gerar_graficos(self, meta_id, caminho_arquivo_pdf, data_atual):
        ...
        nome_arquivo_imagem = f'grafico_REGISTRO_GERAL_{data_atual}.png'
    ...
    def gerar_pdf(self, texto, meta_id, data_atual):
        ...
        caminho_arquivo = os.path.join(caminho_pasta,
                                       f"relatorio_conferencia_REGISTRO_GERAL_{data_atual}.pdf")
...
if __name__ == "__main__":
    ...
    main_frame = PageConferenciaLivro02(root, None)
