...
class CadastroDeMetasRegistroAuxiliar(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="Cadastro de meta: 3ª CONFERÊNCIA - LIVRO 03 - REGISTRO AUXILIAR",
                         font=("Helvetica", 24))
        label.pack(pady=20)

        entry_label1 = tk.Label(self, text="Total de 3ª CONFERÊNCIA - REGISTRO AUXILIAR:", font=("Helvetica", 16))
